...
> Тест SSD и кардридера проводился с помощью BlackMagic Disk Speed Test. Карта SD Transcend UHS-I (SD 3.0)
> с заявленным 125 Мб/c на запись и 160 Мб/с на чтение. Похоже, что кардридер не изменился, но я в этом не уверен.
...
Большинство тестов вы можете воспроизвести самостоятельно — большинство репозиториев открыты.
Я указываю конкретные коммиты, на которых следует запускать тесты,
