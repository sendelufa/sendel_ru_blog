...
В этой гайде будет вы можете использовать
<a href="https://github.com/sendelufa/lesson-liquibase-start" target="_blank">готовый старт проекта Spring Boot со сборщиком Gradle</a>
(ветка master)
